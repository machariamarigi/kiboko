...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description:
      "Every asset is verified to ensure the highest quality standards. Not happy? Get a refund within 30 days.",
  },
  {
    name: "For The Planet",
    Icon: Leaf,
    description: "1% of every purchase goes to planting trees.",
  },
];
            ...
            {perks.map((perk) => (
              ...
              >
                <div className="md:flex-shrink-0 flex justify-center">
                  <div className="h-16 w-16 flex items-center justify-center rounded-full bg-orange-100">
